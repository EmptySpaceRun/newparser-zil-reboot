...
<DEFAULTS-DEFINED INIT-HINT-SCREEN LIT? REFRESH CAPITAL-NOUN?>
...
<VERB-SYNONYM SCORE STATUS STATS RANK LEVEL>
...
<SYNTAX CONSULT OBJECT ABOUT OBJECT (EVERYWHERE) = V-SRESEARCH PRE-SRESEARCH ;PRE-SWITCH>
<SYNTAX CONSULT OBJECT ON OBJECT (EVERYWHERE) = V-SRESEARCH PRE-SRESEARCH ;PRE-SWITCH>

<SYNTAX COUGH = V-COUGH>

<SYNTAX COUNT OBJECT (MANY) = V-COUNT PRE-COUNT>

<SYNTAX COVER OBJECT WITH OBJECT (HELD MANY) = V-SPUT-ON PRE-SPUT-ON ;PRE-SWITCH>
...
<SYNTAX FIND OBJECT (EVERYWHERE) IN OBJECT = V-SSEARCH-OBJECT-FOR PRE-SSEARCH-OBJECT-FOR ;PRE-SWITCH>
...
<SYNTAX LOOK FOR OBJECT (EVERYWHERE) IN OBJECT
	= V-SSEARCH-OBJECT-FOR PRE-SSEARCH-OBJECT-FOR ;PRE-SWITCH>
...
<SYNTAX READ IN OBJECT ABOUT OBJECT (EVERYWHERE) = V-SRESEARCH PRE-SRESEARCH ;PRE-SWITCH>  
...
<SYNTAX THROW OBJECT (ON-GROUND IN-ROOM) OBJECT (CARRIED)
	= V-STHROW PRE-STHROW ;PRE-SWITCH>
...
<SYNTAX TOUCH OBJECT (HAVE) TO OBJECT = V-STOUCH PRE-STOUCH ;PRE-SWITCH>
<SYNTAX TOUCH OBJECT (HAVE) ON OBJECT = V-STOUCH PRE-STOUCH ;PRE-SWITCH>
...
<SYNTAX WALK TO OBJECT ON OBJECT = V-SRIDE-DIR PRE-SRIDE-DIR ;PRE-SWITCH>
<SYNTAX WALK TO OBJECT IN OBJECT = V-SRIDE-DIR PRE-SRIDE-DIR ;PRE-SWITCH>
...
<SYNTAX WRAP OBJECT IN OBJECT (HELD MANY) = V-SWRAP PRE-SWRAP ;PRE-SWITCH>
...
<ROUTINE V-$REFRESH ("OPTIONAL" (DONT-CLEAR <>))
	 ...
	 <UPDATE-STATUS-LINE>
	 <LOWCORE FLAGS <BAND <LOWCORE FLAGS> <- -1 ,F-REFRESH> ;-5>>
...
<ROUTINE CAPITAL-NOUN? (WRD "AUX" TBL)
   <COND (<OR <EQUAL? .WRD ,W?MAX ,W?FOG ,W?O\'GARRA ,W?OGARRA ,W?FOUQUET>>
	  <RTRUE>)
